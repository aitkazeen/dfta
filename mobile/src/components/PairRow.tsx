...
export function PairRow({ pair, onPress, divider }: Props) {
  ...
  const dirColor = { up: colors.up, down: colors.down, flat: colors.flat }[pair.direction]
  ...
  return (
    ...
    >
      ...
      <View style={styles.mid}>
        ...
        <Text tabular style={{ color: dirColor, fontFamily: fontFamily.medium, fontSize: 13, lineHeight: 18 }}>
