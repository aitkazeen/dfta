...
const usdKzt: FullForecast = {
  ...
  drivers: [
    ...
    },
    {
      ...
      impact: 'Технические индикаторы указывают на сохранение восходящего импульса в ближайшие дни.',
      source: 'Технический анализ',
    },
    {
      category: 'global',
      what: 'ФРС сохранила ставку, риторика жёстче ожиданий',
      impact: 'Более жёсткая риторика ФРС временно ослабляет доллар на глобальных площадках.',
      source: 'Reuters',
    },
  ],
  accuracy: { total: 148, windowDays: 90, hitRatePct: 61 },
  trend: {
    predicted: [508, 508.5, 509, 509.5, 510, 510.4, 510.8, 511.2, 511.6, 512, 512.3],
    actual: [508, 508.3, 509.4, 509.1, 510.3, 510.9, 510.5, 511.5, 511.3, 512.2, 511.9],
  },
}
